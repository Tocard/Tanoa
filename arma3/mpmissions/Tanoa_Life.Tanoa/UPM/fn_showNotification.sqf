...
switch (_color) do {
    case "blue":    { _stripColor = [0, 0, 1, 1]    };
    case "red":     { _stripColor = [1, 0, 0, 1]    };
    case "orange":  { _stripColor = [0.8, 0.5, 0, 1]};
    case "green":   { _stripColor = [0, 1, 0, 1]    };
    case default  { _stripColor = [0, 0, 1, 1]    };
};
